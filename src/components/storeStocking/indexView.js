...
define([
    ...
    var View = Backbone.View.extend({
        ...
        delOne: function (row) {
            ...
            bootbox.confirm({
                ...
                callback: function (result) {
                    if (result) {
                        ncjwUtil.postData(QUERY.STOCK_STOCKING_DELETE, {id: row.id}, function (res) {
                            if (res.success) {
        ...
        completeStore: function (row) {
            ...
            var that = this;
            ncjwUtil.postData(QUERY.STORE_STOCKING_COMPLETE, JSON.stringify(params), function(res) {
                if (res.success) {
        ...
        submitForm: function (e) {
            if(this.$editForm.valid()){
                ...
                var id = $('#id').val();
                ncjwUtil.postData(id ? QUERY.STOCK_STOCKING_UPDATE : QUERY.STOCK_STOCKING_INSERT, JSON.stringify(JSONData), function (res) {
                    if (res.success) {
