...
(function () {
    ...
    var config = {
        ...
        paths: {                    //如果某个前缀的依赖不是按照baseUrl拼接这么简单，就需要在这里指出
            ...
            bsSuggest: 'libs/bootstrap.suggest/bootstrap-suggest',
    ...
    require([
        ...
        'datetimepicker_zh',
        'bsSuggest'
    ], function (Backbone, _, Bootstrap, BT, config, AppView, Bootbox, Viewer, WebUploader, Datepicker, DatepickerCN, Datetimepicker, DatetimepickerCN, BsSuggest) {
        new AppView();
